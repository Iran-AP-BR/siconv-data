...
csv_fornecedores_type = {
    'FORNECEDOR_ID': 'int64',
    'IDENTIF_FORNECEDOR': 'object',
    'NOME_FORNECEDOR': 'object'
}

csv_emendas_type_convenios = {
    'NR_EMENDA': 'int64',
    'NR_CONVENIO': 'int64',
...
def set_types(df, dtypes):
    ...
    elif dtypes==csv_movimento_type:
        df['DATA_MOV'] = pd.to_datetime(df['DATA_MOV'], dayfirst=True)
    elif dtypes==csv_calendario_type:
        df['DATA'] = pd.to_datetime(df['DATA'], dayfirst=True)
    elif dtypes==csv_data_atual_type:
