...
class ETL(object):
    ...
    def pipeline(self, force_download=True, force_transformations=False, force_database_load=False):
        files_ok = False
        db_ok = False
        try:
        ...
        try:
            ...
            if self.engine is not None:
                self.check_update(target='db', force_update=force_database_load)
